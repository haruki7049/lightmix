...
- **Flat Generic Typing**:
  Audio samples are generic over `comptime T: type` (`f32`, `f64`, `f80` and `f128`). No single floating-point precision is prioritized; users choose the balance between precision and memory overhead.
