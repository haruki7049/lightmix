...
2. **Sample Rate**: Examples use 44100 Hz (CD quality)
3. **Format**: Output is typically 16-bit PCM WAV (.i16)
4. **Allocator**: Examples use page_allocator for simplicity
5. **Error Handling**: Uses `try` and `!` for proper error propagation
